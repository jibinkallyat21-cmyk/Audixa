...
const BADGE_TONE = { red: 'bg-brand-red text-white', amber: 'bg-amber text-white' }
    ...
    <header className="relative flex h-[52px] w-full shrink-0 items-center justify-between border-b border-white/[0.08] bg-navy px-6 text-white">
      ...
      <div className="flex items-center gap-4">
        <div
          ...
          className="flex items-center gap-1 rounded-full border border-white/20 bg-white/5 p-0.5 text-[10px] font-semibold"
        >
    ...
    <SidebarDrawerProvider>
      <div className="flex min-h-screen w-full bg-background">
        ...
        <div className="flex min-h-screen flex-1 flex-col">
          ...
          <main className="relative flex-1 overflow-y-auto px-4 py-6 sm:px-8 sm:py-8">{children}</main>
          <Footer />
        </div>
      </div>
    </SidebarDrawerProvider>
