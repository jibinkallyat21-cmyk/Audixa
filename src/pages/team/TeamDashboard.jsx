            ...
            {teamActionCards.map((card, idx) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ y: -2 }}
                  className={`rounded-xl border bg-white p-5 shadow-sm transition-shadow duration-200 hover:shadow-lg ${tone.border} ${tone.glow}`}
                >
